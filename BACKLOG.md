...
### BL-BUG-03 — /eeprom/propose OOM on uncached large session pairs
**Priority:** MEDIUM
**Found:** 2026-06-11 while restoring the proposal engine

First-time VS compare of a large uncached pair (653DC0 vs 248AE2, 103k samples)
pushed memory to 91% on the Pi Zero 2W — the OOM watchdog killed and restarted
the logger mid-request. Cached pairs respond fine.
